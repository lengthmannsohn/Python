...
# LOS METODOS SE DECLARAN AL INICIO
# LA SINTAXIS DE NOMBRES DE METODOS ES
# primeraSegundaTercera
def primerMetodo():
        # ESTE CODIGO NUNCA SE EJECUTARÁ SI NO LO
        # LLAMAMOS DE FORMA EXPLICITA
        print("Soy el primer metodo")
def segundoMetodo():
